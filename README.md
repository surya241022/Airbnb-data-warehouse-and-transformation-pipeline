<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:0EA5A5,100:7C6FF0&height=230&section=header&text=Airbnb%20End-To-End%20Data%20Engineering&fontSize=36&fontColor=ffffff&animation=fadeIn&fontAlignY=36&desc=Raw%20S3%20Data%20%E2%86%92%20Snowflake%20%E2%86%92%20dbt%20%E2%86%92%20Star%20Schema%20%E2%86%92%20Power%20BI&descAlignY=58&descSize=17" />
</p>

<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Segoe+UI&weight=600&size=21&duration=2600&pause=800&color=7C6FF0&center=true&vCenter=true&width=820&lines=Medallion+Architecture+%E2%80%94+Bronze+%E2%86%92+Silver+%E2%86%92+Gold;Metadata-Driven%2C+YAML-Configured+dbt+Pipelines;Star+Schema+with+SCD+Type+2+History+Tracking;Row-Level+Security+on+Every+Query;Live+Power+BI+Executive+Dashboards" alt="Typing SVG" />
</p>

<p align="center">
  <img src="https://img.shields.io/badge/AWS-S3-0EA5A5?style=for-the-badge&logo=amazonaws&logoColor=white" />
  <img src="https://img.shields.io/badge/Snowflake-Data%20Warehouse-F5A623?style=for-the-badge&logo=snowflake&logoColor=white" />
  <img src="https://img.shields.io/badge/dbt-Transformations-FF6F59?style=for-the-badge&logo=dbt&logoColor=white" />
  <img src="https://img.shields.io/badge/Power%20BI-Dashboards-7C6FF0?style=for-the-badge&logo=powerbi&logoColor=white" />
  <img src="https://img.shields.io/badge/GitHub-Version%20Control-1F2937?style=for-the-badge&logo=github&logoColor=white" />
</p>
...
<p align="center"><i>Pulled straight from the Gold-layer Star Schema — the same numbers the Power BI report surfaces.</i></p>
...
<p align="center">
  <img src="docs/architecture.jpg" width="900" alt="Full end-to-end architecture — S3, Snowflake Bronze, dbt OBT + metadata pipeline, Star Schema with security, Power BI dashboards" />
</p>
...
The full report, with the detailed KPIs each page surfaces.
...
<img src="Airbnb_Dashboard/dashboaed_view_1.jpeg" width="100%" />
...
<img src="Airbnb_Dashboard/dashboard_view_2_.jpeg" width="100%" />
...
│   ├── dashboaed_view_1.jpeg             # Report page 1 screenshot
│   └── dashboard_view_2_.jpeg            # Report page 2 screenshot
├── docs/
│   ├── hero_stats.svg                # Custom animated stats graphic
...
1. Review the animated pipeline diagram to see how data moves stage to stage
2. Open `AirbnbPerformanceDashboard.pbix` in **Power BI Desktop**
3. Use the filter panes (City, Property Type, Room Type, Booking Status) to slice the data
4. On the Revenue & Pricing Analysis page, click into the decomposition tree to drill from Total Revenue down through Room Type → Property Type → City

---

<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:7C6FF0,100:0EA5A5&height=120&section=footer" />
</p>
